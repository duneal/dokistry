...
# -----------------------------
# Script: Docker Registry GC (sans arrêt/redémarrage)
# -----------------------------
...
# 3️⃣ Log de la taille du volume registry avant GC
...
# 4️⃣ Lancer Garbage Collector réel
...
# 5️⃣ Log de la taille du volume registry après GC
